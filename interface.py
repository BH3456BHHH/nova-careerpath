...
def _overview(result):
    ...
    # ── Photo detection warning (industry-dependent) ─────────────────────────
    if result.get("photo_detected"):
        ...
        <div style="background:linear-gradient(135deg,#FEF2F2,#FFF5F5);
          ...
          <div>
            <div style="font-size:14px;font-weight:800;color:#991B1B;margin-bottom:2px;">
              Photo detected on your CV
            </div>
            <div style="font-size:13px;color:#7F1D1D;line-height:1.5;">
              Industry-dependent: usually a red flag for consulting, banking and tech —
              sometimes welcomed in marketing or creative fields. Consider removing it
              unless your target industry expects one.
            </div>
          </div>
        </div>
        """, unsafe_allow_html=True)
