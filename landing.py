...
div[data-testid="stExpander"] {
    ...
    box-shadow: 0 1px 6px rgba(10,22,40,0.04) !important;
}
...
div[data-testid="stExpander"] summary span { color: #0A1628 !important; }
div[data-testid="stExpander"] > div > div { background: white !important; }
div[data-testid="stExpander"]:focus-within { box-shadow: none !important; border-color: #EAEFF6 !important; }
...
def landing_page():
    ...
    with faq_col:
        ...
        for q, a in faqs:
            with st.expander(q):
                st.markdown(f"<p style='padding:6px 4px 14px;font-size:14px;color:#334455;line-height:1.75'>{a}</p>", unsafe_allow_html=True)
